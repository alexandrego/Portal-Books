...
<div class="elemento">
  ...
  <div class="sub-elemento-slide">
    ...
    <div class="width-slide-livros-em-leitura">
      ...
      <div class="btn-slideDiv">
        <button class="slideRight" type="button"><img src="assets/icons/arrow-circle-right.svg" class="icon-btn-slide"/></button>
      </div>
    </div>
